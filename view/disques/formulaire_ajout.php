...
<!--        titre-->
        <label for="titre" class="text-light text-light fondopac">Title :</label>
...
<!--        artiste-->
<label for="artiste" class="text-light mt-md-2 text-light fondopac">Artiste :</label>
...
<!--        année du disque-->
<label for="annee" class="text-light mt-md-2 text-light fondopac"> Year :</label>
...
<!--        genre du disque-->
<label for="genre" class="text-light mt-md-2 text-light fondopac">Genre :</label>
...
<!--        label du disque-->
<label for="label" class="text-light mt-md-2 text-light fondopac">Label :</label>
...
<!--        prix du disque-->
<label for="prix" class="text-light mt-md-2 text-light fondopac">Price :</label>
...
<!--        image du disque-->
<label for="image" class="text-light mt-md-2 text-light fondopac">Picture :</label>
